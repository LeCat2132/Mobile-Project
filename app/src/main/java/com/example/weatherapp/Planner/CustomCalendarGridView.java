...
public class CustomCalendarGridView extends LinearLayout {
    ...
    Planner_ArrayAdapter myArrayAdapter;
    int lastClicked = -1;
    ...
    public CustomCalendarGridView(Context context, @Nullable AttributeSet attrs) {
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                eventName = newView.findViewById(R.id.eventName);
                eventTimeSelector = newView.findViewById(R.id.timeSetForEvent);
                eventTime = newView.findViewById(R.id.timeEvent);
                eventDone = newView.findViewById(R.id.doneBtn);
                ...
                alertDialog.setOnCancelListener(dialog -> updateCalendar());
    ...
    protected void updateCalendar(){
        ...
        myArrayAdapter = new Planner_ArrayAdapter(context,dateList,eventsList,calendar,lastClicked,curCal);
